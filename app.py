...
def main():
    ...
    with st.sidebar:
        ...
        selected = option_menu(
            menu_title=None,
            options=["Dashboard", "Inventory", "Suppliers", "Logistics",
                     "Forecasting", "Reports"],
            icons=["speedometer2", "box-seam", "building", "truck",
                   "robot", "file-earmark-text"],
            default_index=0,
            styles={
    ...
    if selected == "Dashboard":
        ...
        from pages.logistics import render_logistics
        render_logistics()
